...
var (
	...
	Params = map[string][]string{
		...
		"slacknotify.msg":                                 {"A message."},
		"slacknotify.webhook":                             {"A webhook url."},
	...
	Groups = []common.GroupsEntry{
		...
		{
			Name:    "customActions",
			Title:   "Custom actions (defined in Gopherciser extended example)",
			Actions: []string{"dummy", "slacknotify"},
			DocEntry: common.DocEntry{
				Description: "",
				Examples:    "",
			},
